...
```{r tools}
tools <- tools %>% mutate(Tool = factor(Tool, levels = c("MS Access", "Git/Github/Gitlab Version Control", "Python", "SQL", "MS Visio", "MS Word", "MS Powerpoint", "MS Excel", "VBA", "R"))) 
g <- ggplot(tools) +
  theme_minimal() +
...
ggsave(filename = "Images/tools.png", plot = g, bg = "transparent", dpi = 600, width = 5, height = 4)
```
