...
- ⚡ Fun fact: The data in this .md file comes from Google Sheets and is created with R and 💖
...
```{r tools}
tools %>% mutate(Tool = factor(Tool, levels = c("MS Access", "Git/Github/Gitlab Version Control", "Python", "SQL", "MS Visio", "MS Word", "MS Powerpoint", "MS Excel", "VBA", "R"))) %>% 
ggplot() +
  theme_minimal() +
