...
-   :telescope: In process of migrating my [distill website and blog hosted on Netlify](https://vishalkatti.com "https://vishalkatti.com") to Quarto!
...
```{r tools}
tools <- tools %>% mutate(Tool = factor(Tool, levels = c("MS Access", "Git/Github/Gitlab Version Control","MS Visio","Apache Spark with Databricks","Python for Data Analysis", "MS Word/Powerpoint","SQL", "Advanced Excel + VBA", "R"))) 
g <- ggplot(tools) +
  theme_minimal() +
