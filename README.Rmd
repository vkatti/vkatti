...
```{r tools}
tools <- tools %>% mutate(Tool = factor(Tool, levels = c("MS Access", "Git/Github/Gitlab Version Control","PowerApps/PowerBI","Apache Spark with Databricks","Python for Data Analysis", "MS Word/Powerpoint","SQL", "Advanced Excel + VBA", "R"))) 
g <- ggplot(tools) +
  theme_minimal() +
